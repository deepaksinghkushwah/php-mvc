...
<head>
  ...
  <link href="<?=SITE_URL.'public/admin/'?>vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="<?=SITE_URL.'public/admin/'?>css/sb-admin-2.min.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pagemanager" aria-expanded="true" aria-controls="collapseTwo">
          <i class="fas fa-fw fa-cog"></i>
          <span>Page Manager</span>
        </a>
        <div id="pagemanager" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <!--<h6 class="collapse-header">Custom Components:</h6>-->
            <a class="collapse-item" href="<?=SITE_URL.'pagemanager/create'?>">New</a>
            <a class="collapse-item" href="<?=SITE_URL.'pagemanager/index'?>">List</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="usermanager" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <!--<h6 class="collapse-header">Custom Components:</h6>-->
            <a class="collapse-item" href="<?=SITE_URL.'usermanager/create'?>">New</a>
            <a class="collapse-item" href="<?=SITE_URL.'usermanager/index'?>">List</a>
          </div>
        </div>
      </li>
