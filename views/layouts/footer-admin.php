  ...
  <script src="<?=SITE_URL.'public/admin/'?>vendor/jquery/jquery.min.js"></script>
  ...
  <script src="<?=SITE_URL.'public/admin/'?>js/sb-admin-2.min.js"></script>
  <script src="<?=SITE_URL.'public/js/common.js'?>"></script>
  <?php
if (isset($this->js)) {
